              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-6">
                  <div className="relative">
                    <div className="w-24 h-24 rounded-full overflow-hidden bg-orange-500/20 flex items-center justify-center">
                      {profilePicPreview ? (
                        <img
                    ...
                    <button
                      ...
                      className="absolute bottom-0 right-0 bg-orange-500 text-white p-2 rounded-full hover:bg-orange-600 transition-colors duration-200 shadow-lg"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex space-x-2 mt-3">
                      <button
                        onClick={() => fileInputRef.current?.click()}
                        className="flex items-center space-x-2 px-3 py-2 bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/30 transition-colors duration-200 text-sm"
                      >
                      ...
                      {profilePicPreview && (
                        <button
                          ...
                          className="px-3 py-2 bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 rounded-lg hover:bg-red-200 dark:hover:bg-red-900/30 transition-colors duration-200 text-sm"
                        >
                          Remove
                        </button>
                      )}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { key: 'defenseSystem', label: 'Defense System', description: 'TaskDefender procrastination defense alerts' },
                  ].map(setting => (
