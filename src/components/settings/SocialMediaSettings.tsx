...
const SocialMediaSettings: React.FC = () => {
  ...
  const connectAccount = (platform: 'twitter' | 'linkedin' | 'facebook' | 'devto') => {
    ...
    const mockUrls = {
      ...
      devto: 'https://dev.to/productivity_ninja'
    };
  ...
  const getPlatformColor = (platform: string) => {
    switch (platform) {
      ...
      case 'devto': return 'text-black bg-gray-50 dark:bg-gray-900/20';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h4 className="font-semibold text-gray-900 dark:text-white">Connected Accounts</h4>
