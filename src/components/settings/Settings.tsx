            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-full p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-xl text-left hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-200">
                    <div className="flex items-center justify-between">
                      <div>
                        <h5 className="font-medium text-blue-700 dark:text-blue-400">Export Data</h5>
                        <p className="text-sm text-blue-600 dark:text-blue-300">Download all your productivity data</p>
                      </div>
                      <Smartphone className="h-5 w-5 text-blue-500" />
                    </div>
                  </button>

                  <button className="w-full p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl text-left hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors duration-200">
                    <div className="flex items-center justify-between">
                      <div>
                        <h5 className="font-medium text-red-700 dark:text-red-400">Delete Account</h5>
                        <p className="text-sm text-red-600 dark:text-red-300">Permanently delete your account and data</p>
                      </div>
